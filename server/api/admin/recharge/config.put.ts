...
import { CONFIG_KEY_PAYMENT_DISABLED, getAppConfig, setAppConfig } from '../../../utils/config'
...
export default defineEventHandler(async (event) => {
  ...
  return { paymentDisabled: (await getAppConfig(db, CONFIG_KEY_PAYMENT_DISABLED)) === '1' }
})
